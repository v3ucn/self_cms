    ...
    $.ajax({
        ...
        success:(function (json) {
            ...
            $.each(json.data.appid, function (i,item) {
                str += "<option value='"+ item.appid +"'>" + (item.nick_name || item.appid) + "</option>"
            });
...
function initMerchantConfigTableTable() {
    var table = $("#OfficialAccountManageTable").DataTable({
        ...
        "ajax": { // 获取数据
            ...
            "data": function (d) {
                // d.state = $('#status').val();
                d.appid = $('#officialAccountName').selectpicker('val');
        ...
        "columnDefs": [ //自定义列
            {
                ...
                "render": function (data, type, row) {
                    var htmlStr = "<div>"+"<input class='id_check' name='' type='checkbox' value='-1'/>"+"&nbsp;"+"<span hidden>"+row.id+"</span>"+"<label>"+row.ctime+"</label>"+"</div>";
                    return htmlStr;
                }
            },
            {
            ...
            },
            {
                ...
                "width": 100,
                "render": function (data, type, row) {
                    var htmlStr = "<label>"+row.shop+"</label>";
                    return htmlStr;
                }
            },
            {
            ...
            },
            {
                ...
                "width": 100,
                "render": function (data, type, row) {
                    var htmlStr = "<label>"+row.allfan+"</label>";
                    return htmlStr;
                }
            },
            {
                ...
                "width": 100,
                "render": function (data, type, row) {
                    var htmlStr = "<label>"+row.auser+"</label>";
                    return htmlStr;
                }
            },
            {
                ...
                "width": 100,
                "render": function (data, type, row) {
                    var htmlStr = "<label>"+row.cuser+"</label>";
                    return htmlStr;
                }
            },
            {
